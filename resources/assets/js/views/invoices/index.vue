<template>
    <div class="panel">
        ...
        <div class="panel-footer">
            ...
            <div>
                <button className="btn btn-sm" :disabled="!model.prev_page_url" @clicl="prevPage">
                Prev 
                </button>
                <button className="btn btn-sm" :disabled="!model.next_page_url" @clicl="nextPage">
                Next
                </button>
            </div>
        </div>
